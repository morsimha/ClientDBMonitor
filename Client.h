...
class Client {
	...
	bool addPrivkeyToMeFile(utils& fileUtils, std::fstream& newFile, std::string& encoded_privkey, bool& retFlag) const;
...
public:
	...
	bool addUserToMeFile(utils& fileUtils, std::fstream& newFile, std::string& username, Response& res, char* uuid, bool& retFlag) const;
